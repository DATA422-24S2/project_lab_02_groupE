...
sa2_2023_output_file <- paste0(output_dir, current_date, ".clean-sa2_2023.csv")
subnational_pop_output_file <- paste0(output_dir, current_date, ".clean-subnational_pop_ests.csv")
...
sa2_2023_clean <- sa2_2023_data %>% select(-2)
